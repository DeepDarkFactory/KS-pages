...
var dispatch = __webpack_require__(38).dispatch;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_js_d3_min_js__ = __webpack_require__(14);
...
//构造词云容器svg元素
var svg = __WEBPACK_IMPORTED_MODULE_3__src_js_d3_min_js___default.a.select('.svg-contain').append("svg")
    .attr("width", 960)
    .attr("height", 500)
...
function showNewWords(vis, word) {
    ...
    vis.update(word.slice(0,Math.min(200,word.length)).map(function (d) {
        return {
            text: d.key,
            size: __WEBPACK_IMPORTED_MODULE_3__src_js_d3_min_js___default.a.scale["log"]().range([10, 30])(d.value)
        };
    }))
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_dispatch__ = __webpack_require__(39);
